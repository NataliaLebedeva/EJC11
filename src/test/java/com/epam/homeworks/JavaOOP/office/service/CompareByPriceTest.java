...
public class CompareByPriceTest {
    @Test
    void compareByPriceTest() {
        Comparator<Stationery> comparator = new CompareByPrice();
        ...
        Stationery pencil = new Pencil("pencil", 5.4, "grey", "b2");
        ...
        Assert.assertEquals(objects[0], pen2);
        Assert.assertEquals(objects[objects.length-1], javaBook);
